...
public class FirstClass {
	...
	public static void main(String[] args) {
		...
		// Create Question
				...
				Q1.typeQuestions = TQ5;
				Q1.account = Zuckerberg;
		...
		// Create Exam		
				...
				exam1.duration = 60;
				exam1.account = Zuckerberg;
				exam1.creatDate = new Date("2021/01/03");
				...
				exam2.duration = 120;
				exam2.account = Obama;
				exam2.creatDate = new Date("2021/01/05");
				...
				exam3.duration = 120;
				exam3.account = Trump;
				exam3.creatDate = new Date("2021/01/07");
				...
				exam4.duration = 30;
				exam4.account = Biden;
				exam4.creatDate = new Date("2021/01/10");

				Exam exam5 = new Exam();
				exam5.id = 5;
				exam5.code = "E05";
				exam5.title = "Exam for C#";
				exam5.CategoryQuestion = CQ6;
				exam5.duration = 180;
				exam5.account = Xanh;
				exam5.creatDate = new Date("2021/01/11");
				...
				exam6.duration = 45;
				exam6.account = Ozawa;
				exam6.creatDate = new Date("2021/01/17");
