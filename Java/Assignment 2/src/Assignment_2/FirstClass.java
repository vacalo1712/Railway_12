...
//				System.out.println(acc2.department == null ? "Nhân viên này chưa có phòng ban" : "phòng ban của nv này là: " + acc2.department.departmentName);
...
//					break;
//				case 1:
//					System.out.println("Group cua nv nay la Java");
//					break;
//				case 2:
//					System.out.println("Group cua nv nay la C#");
//					break;
//				case 3:
//					System.out.println("Nhân viên này là người quan trọng, tham gia nhiều group");
//					break;
...
//					System.out.println("Người này là: " + acc1.position.positionName);
//					break;
//				}
...
//				
//				for (Account thongTin : nhomAcc) {
//					System.out.println("Email: " + thongTin.email);
//					System.out.println("Full Name: " + thongTin.fullName);
//					System.out.println("Department: " + thongTin.department.departmentName + "\n");
//				}
//				
//				Question 9:
//					In ra thông tin các phòng ban bao gồm: id và name
				
//				for (Department ttDepartment : listDepartments) {
//					System.out.println("ID: " + ttDepartment.id);
//					System.out.println("Name: " + ttDepartment.departmentName + "\n");
//				}
...
//					System.out.println("Phòng ban: " + listAccounts[i].department.departmentName + "\n");
//					
//				}
...
//					System.out.println("Name: " + listDepartments[i].departmentName + "\n");
//				}
...
//				In ra thong tin tat ca cac gr, - gr2
				for (int i = 0; i < listAccounts.length; i++) {
					if (i != 1) {
